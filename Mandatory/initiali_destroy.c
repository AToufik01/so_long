...
/*   Updated: 2024/02/09 20:11:10 by ataoufik         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	set_image(t_map *mp)
{
	...
	mp->img_c = xmp(mp, "textures/coins1.xpm", 3);
	mp->img_ec = xmp(mp, "textures/exitc.xpm", 4);
	mp->img_eo = xmp(mp, "textures/exito.xpm", 5);
	mp->img_w = xmp(mp, "textures/wall.xpm", 6);
